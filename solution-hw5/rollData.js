...
class Roll {
    ...
    updateElement(){
        ...
        const cartTypeElement = this.elememt.querySelector('.cart-type');
        const cartGlazingElement = this.element.querySelector('.cart-glazing');
        const cartSizeElement = this.element.querySelector('.cart-size');
        const cartPriceElement = this.element.querySelector('.cart-price');

        // cartImageElement.src = rolls[this.type]['imageFile'];
        cartTypeElement.innerText = this.type;
        cartGlazingElement.innerText = this.glazing;
        cartSizeElement.innerText=this.size;
        cartPriceElement.innerText=this.basePrice;
